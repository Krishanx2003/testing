...
const Footer = () => (
  <footer className="flex flex-col mt-5 border-t">
    <div className="flex flex-col md:flex-row justify-between gap-5 sm:px-16 px-6 py-10">
      <div className="flex flex-col justify-start items-start gap-6">
        <Image src="/assets/images/logo.svg" alt="logo" width={118} height={18} className="object-contain" />
    ...
    <div className="flex justify-between items-center flex-wrap border-t sm:px-16 px-6 py-10">
      <p className="text-gray-700">@2024 happen. All rights reserved</p>
